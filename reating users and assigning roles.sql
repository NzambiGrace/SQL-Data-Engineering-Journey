...
create role John1 with login password 'John1@!23' createdb;

create role John2 with login password 'John2@123' createrole
...
create user John6 with login password 'John@123'  
